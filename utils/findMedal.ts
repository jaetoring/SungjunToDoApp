...
import Medal10 from "@/assets/images/medal/blueGrade.png";
import Medal9 from "@/assets/images/medal/greenGrade.png";
import Medal7 from "@/assets/images/medal/orangeGrade.png";
import Medal6 from "@/assets/images/medal/redGrade.png";
import Medal8 from "@/assets/images/medal/yellowGrade.png";
import { ImageSourcePropType } from "react-native";

export const getMedalByLevel = (level: number | null): ImageSourcePropType => {
  if (level === null) return Medal10;
  ...
  if (level >= 36 && level <= 40) return Medal8; // yellow
  if (level >= 41 && level <= 45) return Medal9; // green
  if (level >= 46) return Medal10; // blue
